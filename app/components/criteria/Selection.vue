...
const showNBInfo = computed(() => {
    ...
    return selectedGroup && selectedGroup.startsWith('NB:')
})
...
<template>
    <form id="form" class="px-7 md:px-0" novalidate>
        ...
        <div v-if="showNBInfo" class="md:flex md:items-center mb-6">
            <div class="md:w-1/3"></div>
            <div class="md:w-1/3">
                <div class="bg-white -mt-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-3 text-orange-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd" />
                            </svg>
                        </div>
                        <div class="ml-3">
                            <p class="text-base text-orange-400">
                                PMA (Postmenstrual age) = GA + Postnatal age (สัปดาห์)
                            </p>
                        </div>
                    </div>
                </div>
